...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 42, 2, 817);
    			attr_dev(div1, "class", "slot svelte-1s8hkm2");
    			set_style(div1, "min-height", /*height*/ ctx[0] + "px");
    			add_location(div1, file, 43, 2, 838);
    			attr_dev(div2, "class", "container svelte-1s8hkm2");
    			add_location(div2, file, 41, 0, 791);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "label svelte-148netm");
    			add_location(div, file$1, 13, 4, 178);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*data*/ 1 && t_value !== (t_value = /*label*/ ctx[1] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(13:2) {#each data as label}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 11, 0, 131);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			add_location(span, file$3, 19, 8, 294);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	let span;
    	let t_value = /*data*/ ctx[1][/*iso*/ ctx[2]] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			add_location(span, file$3, 17, 8, 247);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*data, days*/ 3 && t_value !== (t_value = /*data*/ ctx[1][/*iso*/ ctx[2]] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(span);
    		}
    ...
    // (15:2) {#each days as iso, i}
    function create_each_block$1(ctx) {
    	let div;
    	let t;

    	function select_block_type(ctx, dirty) {
    		if (/*data*/ ctx[1][/*iso*/ ctx[2]]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block.c();
    			t = space();
    			attr_dev(div, "class", "day svelte-rg2jxs");
    			add_location(div, file$3, 15, 4, 199);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			if_block.m(div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:2) {#each days as iso, i}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "part");
    			add_location(div, file$3, 13, 0, 151);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { days = [] } = $$props;
    	let { data = [] } = $$props;
    	const writable_props = ["days", "data"];
    ...
    class DayDots extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { days: 0, data: 1 });
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<MonthTicks> was created with unknown prop '${key}'`);
    	});
    ...
    // (23:0) <Timeline {start} {end} title="hi">
    function create_default_slot(ctx) {
    	...
    	const lines = new Lines({
    			props: { data: /*lineData*/ ctx[4] },
    			$$inline: true
    		});

    	const daydots = new DayDots({
    			props: { data: /*dotData*/ ctx[3] },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(23:0) <Timeline {start} {end} title=\\\"hi\\\">",
    		ctx
    	});
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("dotData" in $$props) $$invalidate(3, dotData = $$props.dotData);
    		if ("lineData" in $$props) $$invalidate(4, lineData = $$props.lineData);
    	};
    	...
    	return [year, start, end, dotData, lineData];
    }
