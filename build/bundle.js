...
var app = (function () {
    ...
    /* src/Labels.svelte generated by Svelte v3.21.0 */
    const file$1 = "src/Labels.svelte";
    ...
    // (24:2) {#each data as obj}
    function create_each_block(ctx) {
    	let div;
    	let t_value = /*obj*/ ctx[2].label + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "label svelte-10pjtrs");
    			set_style(div, "top", /*obj*/ ctx[2].value + "px");
    			add_location(div, file$1, 24, 4, 470);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*data*/ 1 && t_value !== (t_value = /*obj*/ ctx[2].label + "")) set_data_dev(t, t_value);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 22, 0, 425);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Lines.svelte generated by Svelte v3.21.0 */

    const file$2 = "src/Lines.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "part line svelte-12onbgf");
    			add_location(div, file$2, 11, 0, 142);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/dots/DayDots.svelte generated by Svelte v3.21.0 */

    const { console: console_1 } = globals;
    const file$3 = "src/dots/DayDots.svelte";
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "dot svelte-1fynz5w");
    			attr_dev(div, "title", div_title_value = /*dot*/ ctx[5].label + "  " + /*d*/ ctx[2].label);
    			set_style(div, "background-color", /*dot*/ ctx[5].color || "steelblue");
    			add_location(div, file$3, 42, 8, 834);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*data*/ 1 && div_title_value !== (div_title_value = /*dot*/ ctx[5].label + "  " + /*d*/ ctx[2].label)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(42:6) {#each d.dots as dot}",
    		ctx
    	});
    ...
    // (40:2) {#each data as d, i}
    function create_each_block$1(ctx) {
    	let div;
    	let t;
    	let each_value_1 = /*d*/ ctx[2].dots;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "day svelte-1fynz5w");
    			set_style(div, "top", /*d*/ ctx[2].value + "px");
    			add_location(div, file$3, 40, 4, 755);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "part container svelte-1fynz5w");
    			add_location(div, file$3, 38, 0, 699);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<DayDots> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("DayDots", $$slots, []);
    ...
    class DayDots extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get data() {
    		throw new Error("<DayDots>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set data(value) {
    		throw new Error("<DayDots>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/ticks/MonthTicks.svelte generated by Svelte v3.21.0 */

    const { console: console_1$1 } = globals;
    const file$4 = "src/ticks/MonthTicks.svelte";
    ...
    // (34:2) {#each months as month, i}
    function create_each_block$2(ctx) {
    	let div;
    	let t0_value = /*month*/ ctx[5].label + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = text(" -");
    			attr_dev(div, "class", "label svelte-f8b2wy");
    			set_style(div, "top", /*month*/ ctx[5].value + "px");
    			add_location(div, file$4, 34, 4, 705);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(34:2) {#each months as month, i}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "part container svelte-f8b2wy");
    			add_location(div, file$4, 32, 0, 643);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let arr = src(start).every("months", end);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<MonthTicks> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("MonthTicks", $$slots, []);
    ...
    class MonthTicks extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    let dotData = Object.keys(commits).map((date) => {
      return {
        value: date,
        label: date,
        dots: commits[date].map((repo) => {
          let color = mapping$1[repo] || 'grey';
          if (!mapping$1[repo]) {
            console.log(repo);
          }
    ...
    /* demo/Graph.svelte generated by Svelte v3.21.0 */

    // (18:0) <Timeline {start} {end} height={2800} title="2019">
    function create_default_slot(ctx) {
    	let t0;
    	let t1;
    	let t2;
    	let current;
    	const monthticks = new MonthTicks({ $$inline: true });
    	...
    	const lines = new Lines({
    			props: { data: /*lineData*/ ctx[2] },
    			$$inline: true
    		});

    	const daydots = new DayDots({ props: { data: dotData }, $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(monthticks.$$.fragment);
    			t0 = space();
    			create_component(labels.$$.fragment);
    			t1 = space();
    			create_component(lines.$$.fragment);
    			t2 = space();
    			create_component(daydots.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(monthticks, target, anchor);
    			insert_dev(target, t0, anchor);
    			mount_component(labels, target, anchor);
    			insert_dev(target, t1, anchor);
    			mount_component(lines, target, anchor);
    			insert_dev(target, t2, anchor);
    			mount_component(daydots, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(monthticks.$$.fragment, local);
    			transition_in(labels.$$.fragment, local);
    			transition_in(lines.$$.fragment, local);
    			transition_in(daydots.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(monthticks.$$.fragment, local);
    			transition_out(labels.$$.fragment, local);
    			transition_out(lines.$$.fragment, local);
    			transition_out(daydots.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(monthticks, detaching);
    			if (detaching) detach_dev(t0);
    			destroy_component(labels, detaching);
    			if (detaching) detach_dev(t1);
    			destroy_component(lines, detaching);
    			if (detaching) detach_dev(t2);
    			destroy_component(daydots, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(18:0) <Timeline {start} {end} height={2800} title=\\\"2019\\\">",
    		ctx
    	});
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("lineData" in $$props) $$invalidate(2, lineData = $$props.lineData);
    	};
