...
var app = (function () {
    ...
    /* src/lines/Line.svelte generated by Svelte v3.21.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			attr_dev(div0, "class", "line svelte-5ghtao");
    			set_style(div0, "border-left", /*width*/ ctx[1] + " solid " + /*color*/ ctx[0]);
    			add_location(div0, file$1, 14, 2, 192);
    			attr_dev(div1, "class", "part");
    			add_location(div1, file$1, 13, 0, 171);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { width = "5px" } = $$props;
    	const writable_props = ["color", "width"];
    	...
    	$$self.$capture_state = () => ({ color, width });
    ...
    class Line extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { color: 0, width: 1 });
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "dot svelte-oxc5bc");
    			attr_dev(div, "title", div_title_value = /*dot*/ ctx[8].label + "  " + /*d*/ ctx[5].label);
    			set_style(div, "background-color", /*dot*/ ctx[8].color || "steelblue");
    			add_location(div, file$2, 64, 8, 1420);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*days*/ 1 && div_title_value !== (div_title_value = /*dot*/ ctx[8].label + "  " + /*d*/ ctx[5].label)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(64:6) {#each d.dots as dot}",
    		ctx
    	});
    ...
    // (62:2) {#each days as d, i}
    function create_each_block(ctx) {
    	let div;
    	let t;
    	let each_value_1 = /*d*/ ctx[5].dots;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "day svelte-oxc5bc");
    			add_location(div, file$2, 62, 4, 1357);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "part container svelte-oxc5bc");
    			add_location(div, file$2, 60, 0, 1301);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	data = data.map(d => {
    		d.value = src(d.value).format("iso-short");
    		return d;
    	});
    ...
    */
    ...
    // (16:0) <Timeline {start} {end} height={2800} title="2019">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(16:0) <Timeline {start} {end} height={2800} title=\\\"2019\\\">",
    		ctx
    	});
