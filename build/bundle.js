...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 43, 0, 946);
    		},
    ...
    /* src/shapes/Horizontal.svelte generated by Svelte v3.24.1 */
    const file$4 = "src/shapes/Horizontal.svelte";

    function add_css$4() {
    	var style = element("style");
    	style.id = "svelte-nbfvlj-style";
    	style.textContent = ".line.svelte-nbfvlj{height:100%;height:5px;cursor:default;border-radius:3px;z-index:1;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2)}.line.svelte-nbfvlj:hover{opacity:1;box-shadow:2px 2px 8px 0px steelblue}.wide.svelte-nbfvlj{position:absolute;min-height:3px;font-size:0.8rem}.label.svelte-nbfvlj{margin:10px}.hide.svelte-nbfvlj{display:none}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			t = text(/*label*/ ctx[1]);
    			attr_dev(div0, "class", "label svelte-nbfvlj");
    			toggle_class(div0, "hide", /*hide*/ ctx[2]);
    			add_location(div0, file$4, 20, 2, 566);
    			attr_dev(div1, "class", "wide line svelte-nbfvlj");
    			...
    			add_location(div1, file$4, 16, 0, 426);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Horizontal extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-nbfvlj-style")) add_css$4();
    ...
    const file$5 = "src/shapes/Dots.svelte";
    ...
    const file$6 = "src/shapes/Line.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 50, 4, 1341);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(div, "rotate", /*rotate*/ ctx[9]);
    			toggle_class(div, "hide", /*hide*/ ctx[2]);
    			add_location(div, file$6, 46, 4, 1249);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			div.innerHTML = /*label*/ ctx[6];
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 64, 4, 1658);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 61, 2, 1559);
    			...
    			add_location(div1, file$6, 43, 0, 1094);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$7 = "src/shapes/Era.svelte";

    function add_css$6() {
    	var style = element("style");
    	style.id = "svelte-4n85yw-style";
    	style.textContent = ".container.svelte-4n85yw{width:100%;position:absolute;display:flex;flex-direction:row;justify-content:flex-end;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch}.label.svelte-4n85yw{font-size:16px;margin-right:0.75rem;color:#606c74}.line.svelte-4n85yw{height:100%;width:10px;border-radius:3px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 21, 2, 605);
    			attr_dev(div1, "class", "line svelte-4n85yw");
    			set_style(div1, "background-color", /*color*/ ctx[0]);
    			add_location(div1, file$7, 22, 2, 663);
    			...
    			add_location(div2, file$7, 20, 0, 496);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$8 = "src/shapes/Dash.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 19, 0, 473);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Dash extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-b1q74g-style")) add_css$7();
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$9, 25, 4, 596);
    			attr_dev(div1, "class", "subtitle svelte-cxnw7i");
    			add_location(div1, file$9, 28, 4, 687);
    ...
    class Point extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-cxnw7i-style")) add_css$8();
    ...
    const file$a = "src/shapes/Label.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "top svelte-m3p4u2");
    			set_style(div, "color", /*color*/ ctx[0]);
    			set_style(div, "color", /*color*/ ctx[0]);
    			set_style(div, "font-size", /*size*/ ctx[8]);
    			toggle_class(div, "hide", /*hide*/ ctx[4]);
    			add_location(div, file$a, 51, 4, 1278);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(/*label*/ ctx[9]);
    			attr_dev(div0, "class", "line svelte-m3p4u2");
    			set_style(div0, "max-width", /*width*/ ctx[2]);
    			set_style(div0, "background-color", /*color*/ ctx[0]);
    			add_location(div0, file$a, 54, 2, 1405);
    			attr_dev(div1, "class", "label svelte-m3p4u2");
    			set_style(div1, "color", /*color*/ ctx[0]);
    			...
    			add_location(div1, file$a, 55, 2, 1481);
    			attr_dev(div2, "class", "container svelte-m3p4u2");
    			...
    			add_location(div2, file$a, 45, 0, 1122);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Label extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-m3p4u2-style")) add_css$9();
    ...
    function add_css$a() {
    	...
    	style.textContent = ".container.svelte-kxduf8{flex:1;height:100%;height:100%;width:800px;margin-bottom:5rem}.row.svelte-kxduf8{display:flex;flex-direction:row;justify-content:center;align-items:center;text-align:center;flex-wrap:wrap;align-self:stretch}.col.svelte-kxduf8{display:flex;flex-direction:column;justify-content:space-around;align-items:center;text-align:center;flex-wrap:wrap;align-self:stretch}a.svelte-kxduf8{color:steelblue;text-decoration:none}.f2.svelte-kxduf8{font-size:2rem}.f1.svelte-kxduf8{font-size:1.2rem;margin:3rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }

    // (43:8) <Column width="80px">
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(horizontal2.$$.fragment);
    			t2 = space();
    			create_component(horizontal3.$$.fragment);
    			t3 = space();
    			create_component(horizontal4.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(horizontal0, target, anchor);
    			insert_dev(target, t0, anchor);
    			mount_component(horizontal1, target, anchor);
    			insert_dev(target, t1, anchor);
    			mount_component(horizontal2, target, anchor);
    			insert_dev(target, t2, anchor);
    			mount_component(horizontal3, target, anchor);
    			insert_dev(target, t3, anchor);
    			mount_component(horizontal4, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			...
    			transition_in(horizontal2.$$.fragment, local);
    			transition_in(horizontal3.$$.fragment, local);
    			transition_in(horizontal4.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(horizontal0.$$.fragment, local);
    			transition_out(horizontal1.$$.fragment, local);
    			transition_out(horizontal2.$$.fragment, local);
    			transition_out(horizontal3.$$.fragment, local);
    			transition_out(horizontal4.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(horizontal0, detaching);
    			if (detaching) detach_dev(t0);
    			destroy_component(horizontal1, detaching);
    			if (detaching) detach_dev(t1);
    			destroy_component(horizontal2, detaching);
    			if (detaching) detach_dev(t2);
    			destroy_component(horizontal3, detaching);
    			if (detaching) detach_dev(t3);
    			destroy_component(horizontal4, detaching);
    		}
    	};
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(58:8) <Column width=\\\"140px\\\">",
    		ctx
    	});
    ...
    // (42:6) <Timeline start="1939" end="Dec 30 2022" height="700">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(42:6) <Timeline start=\\\"1939\\\" end=\\\"Dec 30 2022\\\" height=\\\"700\\\">",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$b, 18, 4, 433);
    			attr_dev(span, "class", "grey");
    			add_location(span, file$b, 19, 4, 531);
    			attr_dev(div0, "class", "m3 f1 svelte-kxduf8");
    			add_location(div0, file$b, 17, 2, 409);
    			set_style(div1, "height", "100%");
    			set_style(div1, "width", "400px");
    			add_location(div1, file$b, 30, 4, 782);
    			attr_dev(div2, "class", "container row svelte-kxduf8");
    			add_location(div2, file$b, 21, 2, 619);
    			attr_dev(div3, "class", "col svelte-kxduf8");
    			add_location(div3, file$b, 16, 0, 389);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Demo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-kxduf8-style")) add_css$a();
