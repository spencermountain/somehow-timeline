...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 102, 4, 2220);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(div, "rotate", /*rotate*/ ctx[8]);
    			add_location(div, file$5, 98, 4, 2139);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			div.innerHTML = /*label*/ ctx[5];
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 114, 4, 2515);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 111, 2, 2416);
    			...
    			add_location(div1, file$5, 94, 0, 1983);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Line extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-wx2l2y-style")) add_css$4();
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div2, file$6, 45, 0, 941);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 26, 0, 544);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function add_css$7() {
    	...
    	style.textContent = ".container.svelte-4oje91{position:relative;display:flex;flex-direction:column;justify-content:space-around;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch;transform:translate(0px, -12px)}.circle.svelte-4oje91{border-radius:50%;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2)}.circle.svelte-4oje91:hover{box-shadow:2px 2px 8px 0px steelblue}.text.svelte-4oje91{color:#8c8c8c}.subtitle.svelte-4oje91{margin-top:3.5rem;font-size:1rem;color:lightgrey;position:absolute;font-style:italic;min-width:8rem;margin-left:3rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 56, 2, 1183);
    			attr_dev(div1, "class", "subtitle svelte-4oje91");
    			add_location(div1, file$8, 59, 2, 1257);
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*start*/ 64) {
    			 $$invalidate(5, top = myScale(start.epoch));
    		}
    	};
    ...
    class Point extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-4oje91-style")) add_css$7();
    ...
    function add_css$8() {
    	...
    	style.textContent = ".container.svelte-kxduf8{flex:1;height:100%;height:100%;width:800px;margin-bottom:5rem}.row.svelte-kxduf8{display:flex;flex-direction:row;justify-content:center;align-items:center;text-align:center;flex-wrap:wrap;align-self:stretch}.text.svelte-kxduf8{color:#b8b9ba;font-size:2rem;margin-right:1.5rem;height:100%;line-height:3rem;width:120px;text-align:center}.col.svelte-kxduf8{display:flex;flex-direction:column;justify-content:space-around;align-items:center;text-align:center;flex-wrap:wrap;align-self:stretch}a.svelte-kxduf8{color:steelblue;text-decoration:none}.f2.svelte-kxduf8{font-size:2rem}.f1.svelte-kxduf8{font-size:1.2rem;margin:3rem}.dash.svelte-kxduf8{border-left:3px dashed #b8b9ba;min-width:20px;min-height:92%;align-self:stretch;margin-top:4%;margin-bottom:4%}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }

    // (89:6) <Timeline start="Jan 1 2020" end="Dec 30 2020" height="600" width="500">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(89:6) <Timeline start=\\\"Jan 1 2020\\\" end=\\\"Dec 30 2020\\\" height=\\\"600\\\" width=\\\"500\\\">",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$9, 75, 4, 1418);
    			attr_dev(span, "class", "grey");
    			add_location(span, file$9, 76, 4, 1516);
    			attr_dev(div0, "class", "m3 f1 svelte-kxduf8");
    			add_location(div0, file$9, 74, 2, 1394);
    			add_location(br0, file$9, 81, 6, 1672);
    			add_location(br1, file$9, 83, 6, 1697);
    			attr_dev(div1, "class", "text svelte-kxduf8");
    			add_location(div1, file$9, 79, 4, 1636);
    			attr_dev(div2, "class", "dash svelte-kxduf8");
    			add_location(div2, file$9, 86, 4, 1733);
    			set_style(div3, "height", "100%");
    			set_style(div3, "max-width", "300px");
    			set_style(div3, "flex", "1");
    			add_location(div3, file$9, 87, 4, 1758);
    			attr_dev(div4, "class", "container row svelte-kxduf8");
    			add_location(div4, file$9, 78, 2, 1604);
    			attr_dev(div5, "class", "col svelte-kxduf8");
    			add_location(div5, file$9, 73, 0, 1374);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(timeline, div3, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    ...
    class Demo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-kxduf8-style")) add_css$8();
