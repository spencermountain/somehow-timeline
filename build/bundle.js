...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "dot svelte-qqgrej");
    			attr_dev(div, "title", div_title_value = /*dot*/ ctx[5].label);
    			set_style(div, "background-color", /*dot*/ ctx[5].color || "steelblue");
    			add_location(div, file$3, 45, 8, 920);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*data*/ 1 && div_title_value !== (div_title_value = /*dot*/ ctx[5].label)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(45:6) {#each d.dots as dot}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "day svelte-qqgrej");
    			set_style(div, "top", /*d*/ ctx[2].value + "px");
    			add_location(div, file$3, 43, 4, 841);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "part container svelte-qqgrej");
    			add_location(div, file$3, 41, 0, 785);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (35:0) <Timeline {start} {end} title="2019">
    function create_default_slot(ctx) {
    	...
    	const lines = new Lines({
    			props: { data: /*lineData*/ ctx[3] },
    			$$inline: true
    		});

    	const daydots = new DayDots({
    			props: { data: /*dotData*/ ctx[2] },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(35:0) <Timeline {start} {end} title=\\\"2019\\\">",
    		ctx
    	});
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let dotData = [
    		{
    			value: "2019-02-02",
    			data: [{ color: "blue", label: "cool" }, { color: "red" }]
    		},
    		{
    			value: "2019-03-02",
    			data: [
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("dotData" in $$props) $$invalidate(2, dotData = $$props.dotData);
    		if ("lineData" in $$props) $$invalidate(3, lineData = $$props.lineData);
    	};
    	...
    	return [start, end, dotData, lineData];
    }
