...
var app = (function () {
    ...
    /* src/lines/Lines.svelte generated by Svelte v3.21.0 */

    const file$2 = "src/lines/Lines.svelte";
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(47:6) {#each d.dots as dot}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "day svelte-inrguz");
    			add_location(div, file$3, 45, 4, 902);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "part container svelte-inrguz");
    			add_location(div, file$3, 43, 0, 846);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/ticks/Ticks.svelte generated by Svelte v3.21.0 */
    const file$4 = "src/ticks/Ticks.svelte";
    ...
    // (48:2) {#each ticks as tick}
    function create_each_block$2(ctx) {
    	let div;
    	let t_value = /*tick*/ ctx[8].label + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "top", /*tick*/ ctx[8].value + "px");
    			add_location(div, file$4, 48, 4, 1050);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(48:2) {#each ticks as tick}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 46, 0, 993);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["format", "every"];
    	...
    	$$self.$set = $$props => {
    		...
    		if ("every" in $$props) $$invalidate(2, every = $$props.every);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("ticks" in $$props) $$invalidate(0, ticks = $$props.ticks);
    	};
    	...
    	return [ticks, format, every];
    }

    class Ticks extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { format: 1, every: 2 });
    ...
    */
    ...
    function create_default_slot(ctx) {
    	...
    	const ticks1 = new Ticks({ props: { every: "week" }, $$inline: true });
