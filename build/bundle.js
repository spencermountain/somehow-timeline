...
var app = (function () {
    ...
    /* Users/spencer/mountain/thensome/components/Head.svelte generated by Svelte v3.24.1 */

    const file = "Users/spencer/mountain/thensome/components/Head.svelte";
    ...
    /* Users/spencer/mountain/thensome/components/Foot.svelte generated by Svelte v3.24.1 */

    const file$1 = "Users/spencer/mountain/thensome/components/Foot.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 61, 0, 1228);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Timeline extends SvelteComponentDev {
    	constructor(options) {
    		...
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { start: 4, end: 5, height: 6 });
    ...
    const file$3 = "src/shapes/Ticks.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 71, 4, 1565);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 69, 0, 1486);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/shapes/Column.svelte";
    ...
    class Column extends SvelteComponentDev {
    	constructor(options) {
    		...
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { label: 0, color: 1, title: 3, margin: 2 });
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 102, 4, 2220);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(div, "rotate", /*rotate*/ ctx[8]);
    			add_location(div, file$6, 98, 4, 2139);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			div.innerHTML = /*label*/ ctx[5];
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 114, 4, 2515);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 111, 2, 2416);
    			...
    			add_location(div1, file$6, 94, 0, 1983);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div2, file$7, 45, 0, 941);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 26, 0, 544);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/shapes/Text.svelte generated by Svelte v3.24.1 */
    const file$9 = "src/shapes/Text.svelte";

    function add_css$8() {
    	var style = element("style");
    	style.id = "svelte-ee50xr-style";
    	style.textContent = ".container.svelte-ee50xr{position:absolute;border-radius:2px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*label*/ ctx[4]);
    			attr_dev(div, "class", "container svelte-ee50xr");
    			set_style(div, "min-width", /*width*/ ctx[1]);
    			set_style(div, "color", /*color*/ ctx[0]);
    			set_style(div, "opacity", /*opacity*/ ctx[2]);
    			set_style(div, "top", /*top*/ ctx[5] + "px");
    			set_style(div, "font-size", /*size*/ ctx[3]);
    			add_location(div, file$9, 26, 0, 528);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	let { color = "steelblue" } = $$props;
    	color = spencerColor.colors[color] || color;
    	const writable_props = ["width", "opacity", "size", "start", "date", "label", "color"];
    	...
    	return [color, width, opacity, size, label, top, start, date];
    }

    class Text extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-ee50xr-style")) add_css$8();
  ...
  src[t.BUILD]}?`);
    ...
    var compromise = {
      '0.0.6': '2014-04-21T19:35:30.962Z',
      '0.0.7': '2014-05-11T15:52:34.532Z',
      '0.0.9': '2014-05-23T14:32:35.650Z',
      '0.1.0': '2014-05-24T00:51:24.708Z',
      '0.1.1': '2014-05-24T13:02:19.457Z',
      '0.1.2': '2014-05-25T12:30:37.902Z',
      '0.1.3': '2014-06-12T01:31:32.162Z',
      '0.1.4': '2014-07-29T17:32:41.933Z',
      '0.2.0': '2014-11-07T23:39:24.236Z',
      '0.2.1': '2014-11-15T00:36:42.840Z',
      '0.2.2': '2014-11-15T00:59:59.182Z',
      '0.2.3': '2015-01-06T17:15:26.468Z',
      '0.3.0': '2015-01-08T12:47:27.637Z',
      '0.3.1': '2015-01-14T14:01:22.804Z',
      '0.3.4': '2015-03-03T04:04:59.160Z',
      '0.3.5': '2015-03-30T01:49:28.889Z',
      '0.3.6': '2015-04-04T21:57:25.925Z',
      '0.3.7': '2015-04-13T02:11:07.495Z',
      '0.3.8': '2015-04-15T00:15:05.258Z',
      '0.3.9': '2015-04-15T02:35:41.564Z',
      '0.3.10': '2015-04-29T03:59:27.372Z',
      '0.4.0': '2015-05-03T02:12:59.571Z',
      '0.5.0': '2015-05-10T22:18:13.984Z',
      '0.5.1': '2015-05-10T22:19:49.118Z',
      '10.5.1': '2017-06-07T02:15:30.172Z',
      '10.5.2': '2017-06-08T19:43:36.744Z',
      '10.6.0': '2017-07-06T00:24:17.553Z',
      '10.6.1': '2017-07-06T01:00:34.540Z',
      '10.7.0': '2017-07-18T15:24:28.437Z',
      '10.7.1': '2017-07-23T16:42:09.296Z',
      '10.7.2': '2017-08-22T14:07:25.403Z',
      '11.0.0': '2017-10-17T19:38:41.552Z',
      '11.0.1': '2017-10-17T20:01:39.638Z',
      '11.0.2': '2017-10-18T14:52:55.138Z',
      '11.1.0': '2017-10-31T20:34:18.342Z',
      '11.2.1': '2017-11-24T02:01:13.966Z',
      '11.2.2': '2018-01-09T20:46:38.215Z',
      '11.2.3': '2018-01-16T21:32:39.744Z',
      '11.3.0': '2018-02-05T18:41:21.066Z',
      '11.4.0': '2018-02-14T22:04:35.038Z',
      '11.5.0': '2018-02-21T17:18:26.852Z',
      '11.5.1': '2018-02-22T19:21:26.467Z',
      '11.5.2': '2018-02-26T15:10:00.596Z',
      '11.5.3': '2018-03-09T03:10:55.509Z',
      '11.6.0': '2018-04-10T20:50:03.014Z',
      '11.7.0': '2018-05-02T20:53:48.290Z',
      '11.8.0': '2018-05-11T17:34:21.315Z',
      '11.9.0': '2018-05-21T16:21:15.011Z',
      '11.9.1': '2018-06-06T15:21:13.509Z',
      '11.10.0': '2018-06-18T18:54:38.077Z',
      '11.10.1': '2018-06-18T20:47:13.872Z',
      '11.11.0': '2018-06-19T16:12:01.177Z',
      '11.12.0': '2018-07-25T21:21:52.614Z',
      '11.12.1': '2018-10-09T18:35:05.871Z',
      '11.12.2': '2018-10-29T15:41:47.708Z',
      '11.12.3': '2018-11-02T16:39:09.502Z',
      '11.12.4': '2018-12-04T04:30:51.519Z',
      '11.12.5': '2019-01-05T17:31:06.748Z',
      '11.12.6': '2019-01-05T19:05:14.532Z',
      '11.13.0': '2019-01-09T00:23:47.101Z',
      '11.13.1': '2019-02-04T19:34:33.950Z',
      '11.13.2': '2019-03-14T14:51:24.487Z',
      '11.14.2': '2019-07-18T20:30:31.957Z',
      '11.14.3': '2019-08-28T20:26:17.941Z',
      '12.0.0-rc1': '2019-11-22T14:42:00.950Z',
      '12.0.0-rc2': '2019-11-26T15:56:56.741Z',
      '12.0.0': '2019-11-28T15:56:22.919Z',
      '12.1.0': '2019-11-29T20:02:31.631Z',
      '12.2.0': '2019-12-04T21:11:39.281Z',
      '12.2.1': '2019-12-06T19:00:10.040Z',
      '12.3.0': '2020-01-10T20:00:31.152Z',
      '13.0.0-rc1': '2020-01-31T14:37:18.935Z',
      '13.0.0': '2020-02-01T17:40:18.883Z',
      '13.1.0': '2020-02-11T20:47:02.509Z',
      '13.1.1': '2020-02-29T18:10:56.589Z',
      '13.2.0': '2020-04-25T17:03:18.651Z',
      '13.3.0': '2020-06-10T19:04:45.300Z',
      '13.3.1': '2020-06-11T23:54:38.376Z',
      '13.3.2': '2020-08-07T16:02:52.281Z',
      '13.4.0': '2020-09-10T16:02:55.295Z',
      '13.5.0': '2020-09-10T20:13:03.328Z',
    };
    ...
    const format$2 = function () {
      // let times = data.time || {}
      let keys = Object.keys(compromise).filter((k) => {
        return semver$1.valid(k)
      });
      return keys.map((sem) => {
        let d = src$1(compromise[sem]);
    ...
    /* Users/spencer/mountain/thensome/drafts/npm-release-timeline/Post.svelte generated by Svelte v3.24.1 */

    const { console: console_1$1 } = globals;
    const file$a = "Users/spencer/mountain/thensome/drafts/npm-release-timeline/Post.svelte";

    function add_css$9() {
    	var style = element("style");
    	style.id = "svelte-109n3a2-style";
    	style.textContent = ".m3.svelte-109n3a2{margin:3rem}.container.svelte-109n3a2{max-width:400px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_if_block_2(ctx) {
    	...
    	line = new Line({
    			props: {
    				start: /*release*/ ctx[7].date,
    				end: /*release*/ ctx[7].end,
    				label: "",
    				opacity: "0.5"
    			},
    			$$inline: true
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const line_changes = {};
    			if (dirty & /*arr*/ 2) line_changes.start = /*release*/ ctx[7].date;
    			if (dirty & /*arr*/ 2) line_changes.end = /*release*/ ctx[7].end;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(103:10) {#if release.type === 'major'}",
    		ctx
    	});
    ...
    // (102:8) {#each arr as release, i}
    function create_each_block_2(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*release*/ ctx[7].type === "major" && create_if_block_2(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(102:8) {#each arr as release, i}",
    		ctx
    	});
    ...
    // (101:6) <Column width="50px" label="Major">
    function create_default_slot_3(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_2 = /*arr*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(101:6) <Column width=\\\"50px\\\" label=\\\"Major\\\">",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(111:10) {#if release.type === 'minor'}",
    		ctx
    	});
    ...
    // (110:8) {#each arr as release}
    function create_each_block_1(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*release*/ ctx[7].type === "minor" && create_if_block_1$1(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(110:8) {#each arr as release}",
    		ctx
    	});
    ...
    // (109:6) <Column width="100px" label="Minor" color="purple">
    function create_default_slot_2(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_1 = /*arr*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(109:6) <Column width=\\\"100px\\\" label=\\\"Minor\\\" color=\\\"purple\\\">",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const dash_changes = {};
    			if (dirty & /*arr*/ 2) dash_changes.date = /*release*/ ctx[7].date;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(119:10) {#if release.type === 'patch'}",
    		ctx
    	});
    ...
    // (118:8) {#each arr as release}
    function create_each_block$1(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*release*/ ctx[7].type === "patch" && create_if_block$2(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(118:8) {#each arr as release}",
    		ctx
    	});
    ...
    // (117:6) <Column width="100px" label="Patch">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(117:6) <Column width=\\\"100px\\\" label=\\\"Patch\\\">",
    		ctx
    	});
    ...
    // (79:4) <Timeline {start} {end} {height}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(79:4) <Timeline {start} {end} {height}>",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "m3 svelte-109n3a2");
    			add_location(div0, file$a, 74, 2, 1717);
    			attr_dev(div1, "class", "m3 container svelte-109n3a2");
    			add_location(div1, file$a, 75, 2, 1762);
    			add_location(div2, file$a, 72, 0, 1689);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*start*/ 4) timeline_changes.start = /*start*/ ctx[2];
    			if (dirty & /*end*/ 8) timeline_changes.end = /*end*/ ctx[3];
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	const format = function (a) {
    		...
    		$$invalidate(1, arr = arr.filter(o => {
    			return (/[a-z]/).test(o.version) === false;
    		}));

    		$$invalidate(2, start = arr[0].date); //.minus(2, 'months') //.format('iso-short')
    		$$invalidate(3, end = arr[arr.length - 1].date); //.format('iso-short')
    		...
    		$$invalidate(2, start = src$1(start)); //.minus(3, 'weeks')
    		$$invalidate(1, arr);
    		console.log(arr);
    	};
    	...
    	if ($$props && "$$inject" in $$props) {
    	 ...
    	 $$invalidate(2, start = "Jan 2014");
    	 $$invalidate(3, end = "August 2020");
    	return [height, arr, start, end, text];
    }

    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-109n3a2-style")) add_css$9();
