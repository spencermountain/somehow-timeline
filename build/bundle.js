...
var app = (function () {
    ...
    class Column extends SvelteComponentDev {
    	constructor(options) {
    		...
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { width: 2, label: 0, title: 3, margin: 1 });
    ...
    */
    ...
    function add_css$5() {
    	...
    	style.textContent = ".container.svelte-ee50xr{position:absolute;border-radius:2px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 32, 2, 667);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			add_location(div, file$6, 30, 2, 649);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*ignore*/ ctx[4] === true) return create_if_block$1;
    ...
    // (48:8) {#each dashes as d}
    function create_each_block$1(ctx) {
    	let dash;
    	let current;

    	dash = new Dash({
    			props: { date: "jan 1 " + /*d*/ ctx[1] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const dash_changes = {};
    			if (dirty & /*dashes*/ 1) dash_changes.date = "jan 1 " + /*d*/ ctx[1];
    ...
    function create_default_slot_3(ctx) {
    	...
    	era2 = new Era({
    			props: { start: "1900", label: "1900s" },
    			$$inline: true
    		});

    	const block = {
    		c: function create() {
    			create_component(era0.$$.fragment);
    			t0 = space();
    			create_component(era1.$$.fragment);
    			t1 = space();
    			create_component(era2.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(era0, target, anchor);
    			insert_dev(target, t0, anchor);
    			mount_component(era1, target, anchor);
    			insert_dev(target, t1, anchor);
    			mount_component(era2, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(era0.$$.fragment, local);
    			transition_in(era1.$$.fragment, local);
    			transition_in(era2.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(era0.$$.fragment, local);
    			transition_out(era1.$$.fragment, local);
    			transition_out(era2.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(era0, detaching);
    			if (detaching) detach_dev(t0);
    			destroy_component(era1, detaching);
    			if (detaching) detach_dev(t1);
    			destroy_component(era2, detaching);
    		}
    	};
    ...
    // (46:4) <Timeline start="1660" height="900">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(46:4) <Timeline start=\\\"1660\\\" height=\\\"900\\\">",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$8, 41, 4, 750);
    			attr_dev(span, "class", "grey");
    			add_location(span, file$8, 42, 4, 848);
    			attr_dev(div0, "class", "m3 f1 svelte-4xf458");
    			add_location(div0, file$8, 40, 2, 726);
    			attr_dev(div1, "class", "container svelte-4xf458");
    			add_location(div1, file$8, 44, 2, 936);
    			attr_dev(div2, "class", "col svelte-4xf458");
    			add_location(div2, file$8, 39, 0, 706);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
