...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 50, 4, 1192);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 48, 0, 1113);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 65, 4, 1528);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 63, 0, 1476);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/shapes/Column.svelte";

    function add_css$3() {
    	var style = element("style");
    	style.id = "svelte-1u6y9h5-style";
    	style.textContent = ".column.svelte-1u6y9h5{flex:1;position:relative}.label.svelte-1u6y9h5{color:grey;font-size:12px;background-color:#fbfbfb;display:block;z-index:4;text-align:center}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 12, 2, 361);
    ...
    const file$4 = "src/shapes/Dots.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "topLabel svelte-ieunup");
    			set_style(div, "color", /*color*/ ctx[0]);
    			...
    			add_location(div, file$5, 50, 4, 1341);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "midLabel svelte-ieunup");
    			toggle_class(div, "rotate", /*rotate*/ ctx[9]);
    			toggle_class(div, "hide", /*hide*/ ctx[2]);
    			add_location(div, file$5, 46, 4, 1249);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			div.innerHTML = /*label*/ ctx[6];
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "dots svelte-ieunup");
    			set_style(div, "background-color", "white");
    			add_location(div, file$5, 64, 4, 1658);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "line svelte-ieunup");
    			set_style(div0, "width", /*width*/ ctx[1]);
    			set_style(div0, "background-color", /*color*/ ctx[0]);
    			add_location(div0, file$5, 61, 2, 1559);
    			attr_dev(div1, "class", "container svelte-ieunup");
    			...
    			attr_dev(div1, "title", /*title*/ ctx[3]);
    			add_location(div1, file$5, 43, 0, 1094);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Line extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-ieunup-style")) add_css$4();
    ...
    /* src/shapes/Era.svelte generated by Svelte v3.24.1 */
    const file$6 = "src/shapes/Era.svelte";

    function add_css$5() {
    	var style = element("style");
    	style.id = "svelte-4n85yw-style";
    	style.textContent = ".container.svelte-4n85yw{width:100%;position:absolute;display:flex;flex-direction:row;justify-content:flex-end;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch}.label.svelte-4n85yw{font-size:16px;margin-right:0.75rem;color:#606c74}.line.svelte-4n85yw{height:100%;width:10px;border-radius:3px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div1 = element("div");
    			attr_dev(div0, "class", "label svelte-4n85yw");
    			set_style(div0, "color", /*color*/ ctx[0]);
    			add_location(div0, file$6, 21, 2, 605);
    			attr_dev(div1, "class", "line svelte-4n85yw");
    			set_style(div1, "background-color", /*color*/ ctx[0]);
    			add_location(div1, file$6, 22, 2, 663);
    			attr_dev(div2, "class", "container svelte-4n85yw");
    			...
    			add_location(div2, file$6, 20, 0, 496);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Era extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-4n85yw-style")) add_css$5();
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "container svelte-b1q74g");
    			attr_dev(div, "title", /*title*/ ctx[4]);
    			...
    			add_location(div, file$7, 19, 0, 473);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$8 = "src/shapes/Point.svelte";

    function add_css$7() {
    	var style = element("style");
    	style.id = "svelte-cxnw7i-style";
    	style.textContent = ".container.svelte-cxnw7i{position:relative;display:flex;flex-direction:column;justify-content:space-around;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch;transform:translate(0px, -12px)}.circle.svelte-cxnw7i{border-radius:50%;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2)}.circle.svelte-cxnw7i:hover{box-shadow:2px 2px 8px 0px steelblue}.text.svelte-cxnw7i{color:#8c8c8c}.subtitle.svelte-cxnw7i{margin-top:3.5rem;font-size:1rem;color:lightgrey;position:absolute;font-style:italic;min-width:8rem;margin-left:3rem}.hide.svelte-cxnw7i{display:none}.circle.svelte-cxnw7i:hover{display:block}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div2 = element("div");
    			attr_dev(div0, "class", "text svelte-cxnw7i");
    			set_style(div0, "font-size", /*font*/ ctx[4]);
    			toggle_class(div0, "hide", /*hide*/ ctx[1]);
    			add_location(div0, file$8, 25, 4, 596);
    			attr_dev(div1, "class", "subtitle svelte-cxnw7i");
    			add_location(div1, file$8, 28, 4, 687);
    			attr_dev(div2, "class", "circle svelte-cxnw7i");
    			set_style(div2, "min-height", /*size*/ ctx[5] + "px");
    			set_style(div2, "min-width", /*size*/ ctx[5] + "px");
    			set_style(div2, "background-color", /*color*/ ctx[0]);
    			add_location(div2, file$8, 31, 4, 748);
    			attr_dev(div3, "class", "container row nowrap svelte-cxnw7i");
    			add_location(div3, file$8, 24, 2, 557);
    			set_style(div4, "position", "absolute");
    			set_style(div4, "top", /*top*/ ctx[6] + "px");
    			set_style(div4, "width", "100%");
    			add_location(div4, file$8, 23, 0, 497);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Point extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-cxnw7i-style")) add_css$7();
    ...
    const file$9 = "src/shapes/Label.svelte";

    function add_css$8() {
    	var style = element("style");
    	style.id = "svelte-17qv9fc-style";
    	style.textContent = ".container.svelte-17qv9fc{width:100%;position:absolute;border-radius:5px;display:flex;flex-direction:row;justify-content:flex-start;align-items:center;text-align:left;flex-wrap:nowrap;align-self:stretch}.line.svelte-17qv9fc{height:100%;width:25px;cursor:default;border-radius:3px;z-index:1;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2)}.line.svelte-17qv9fc:hover{opacity:1;box-shadow:2px 2px 8px 0px steelblue}.label.svelte-17qv9fc{flex:1;margin-left:0.8rem}.isTiny.svelte-17qv9fc{font-size:0.7rem}.top.svelte-17qv9fc{position:absolute;top:-1.8rem;width:100%}.hide.svelte-17qv9fc{display:none}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*topLabel*/ ctx[1]);
    			attr_dev(div, "class", "top svelte-17qv9fc");
    			set_style(div, "color", /*color*/ ctx[0]);
    			set_style(div, "color", /*color*/ ctx[0]);
    			set_style(div, "font-size", /*size*/ ctx[8]);
    			toggle_class(div, "hide", /*hide*/ ctx[4]);
    			add_location(div, file$9, 51, 4, 1278);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*topLabel*/ 2) set_data_dev(t, /*topLabel*/ ctx[1]);
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text(/*label*/ ctx[9]);
    			attr_dev(div0, "class", "line svelte-17qv9fc");
    			set_style(div0, "max-width", /*width*/ ctx[2]);
    			set_style(div0, "background-color", /*color*/ ctx[0]);
    			add_location(div0, file$9, 54, 2, 1405);
    			attr_dev(div1, "class", "label svelte-17qv9fc");
    			...
    			add_location(div1, file$9, 55, 2, 1481);
    			attr_dev(div2, "class", "container svelte-17qv9fc");
    			...
    			attr_dev(div2, "title", /*title*/ ctx[3]);
    			add_location(div2, file$9, 45, 0, 1122);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*onClick*/ ctx[10])) /*onClick*/ ctx[10].apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*label*/ 512) set_data_dev(t2, /*label*/ ctx[9]);
    ...
    class Label extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-17qv9fc-style")) add_css$8();
    ...
    const file$a = "Demo.svelte";

    function add_css$9() {
    	var style = element("style");
    	style.id = "svelte-kxduf8-style";
    	style.textContent = ".container.svelte-kxduf8{flex:1;height:100%;height:100%;width:800px;margin-bottom:5rem}.row.svelte-kxduf8{display:flex;flex-direction:row;justify-content:center;align-items:center;text-align:center;flex-wrap:wrap;align-self:stretch}.col.svelte-kxduf8{display:flex;flex-direction:column;justify-content:space-around;align-items:center;text-align:center;flex-wrap:wrap;align-self:stretch}a.svelte-kxduf8{color:steelblue;text-decoration:none}.f2.svelte-kxduf8{font-size:2rem}.f1.svelte-kxduf8{font-size:1.2rem;margin:3rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }

    // (90:8) <Column width="100px">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(90:8) <Column width=\\\"100px\\\">",
    		ctx
    	});
    ...
    // (89:6) <Timeline start="Jan 1 2020" end="Dec 30 2020" height="600" width="200">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(89:6) <Timeline start=\\\"Jan 1 2020\\\" end=\\\"Dec 30 2020\\\" height=\\\"600\\\" width=\\\"200\\\">",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "f2 svelte-kxduf8");
    			attr_dev(a, "href", "https://github.com/spencermountain/somehow-timeline");
    			add_location(a, file$a, 75, 4, 1425);
    			attr_dev(span, "class", "grey");
    			add_location(span, file$a, 76, 4, 1523);
    			attr_dev(div0, "class", "m3 f1 svelte-kxduf8");
    			add_location(div0, file$a, 74, 2, 1401);
    			set_style(div1, "height", "100%");
    			set_style(div1, "width", "400px");
    			add_location(div1, file$a, 87, 4, 1774);
    			attr_dev(div2, "class", "container row svelte-kxduf8");
    			add_location(div2, file$a, 78, 2, 1611);
    			attr_dev(div3, "class", "col svelte-kxduf8");
    			add_location(div3, file$a, 73, 0, 1381);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("dashes" in $$props) dashes = $$props.dashes;
    ...
    class Demo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-kxduf8-style")) add_css$9();
