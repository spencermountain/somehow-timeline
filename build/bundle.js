...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 107, 2, 2332);
    			...
    			add_location(div1, file$1, 108, 2, 2399);
    			...
    			add_location(div2, file$1, 85, 0, 1841);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/lines/Now.svelte generated by Svelte v3.21.0 */
    const file$2 = "src/lines/Now.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			div2 = element("div");
    			attr_dev(div0, "class", "wide label svelte-hlvir2");
    			...
    			add_location(div1, file$2, 47, 2, 996);
    			...
    			add_location(div2, file$2, 49, 2, 1167);
    			attr_dev(div3, "class", "container svelte-hlvir2");
    			add_location(div3, file$2, 44, 0, 880);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const scale = getContext("scale");
    	let height = scale(src.now().epoch);
    	const writable_props = ["color", "width", "label"];
    	...
    	return [color, width, label, height];
    }

    class Now extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { color: 0, width: 1, label: 2 });
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:2) {#each ticks as tick}",
    		ctx
    	});
    ...
    */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*opacity, side, color, align*/ 15 && div_style_value !== (div_style_value = "top:" + /*obj*/ ctx[4].value + "px; opacity:" + /*opacity*/ ctx[3] + "; border-" + /*side*/ ctx[2] + ": 4px solid " + /*color*/ ctx[0] + ";\n  color:" + /*color*/ ctx[0] + "; text-align: " + /*align*/ ctx[1] + ";")) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["label", "align", "side", "opacity", "value", "color"];
    	...
    	return [color, align, side, opacity, obj, label, value];
    }
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ width, label });
    	...
    	return [width, label, $$scope, $$slots];
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*label*/ ctx[0]);
    			attr_dev(div, "class", "wide svelte-1aq75sc");
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["date", "label", "align", "color"];
    	...
    	return [label, align, color, y, date];
    }
    ...
    /* src/Page.svelte generated by Svelte v3.21.0 */
    ...
    function create_fragment$7(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*page*/ ctx[0] === /*name*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*page*/ ctx[0] === /*name*/ ctx[1]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*page, name*/ 3) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	return [page, name, $$scope, $$slots];
    }

    class Page extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { page: 0, name: 1 });
    ...
    /* examples/year-in-toronto/Number.svelte generated by Svelte v3.21.0 */

    const file$7 = "examples/year-in-toronto/Number.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$7, 88, 4, 2239);
    		},
    		m: function mount(target, anchor, remount) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "svelte-xu7z7u");
    			add_location(button0, file$7, 83, 4, 1978);
    			attr_dev(span, "class", "svelte-xu7z7u");
    			add_location(span, file$7, 84, 4, 2065);
    			button1.disabled = button1_disabled_value = Number(/*number*/ ctx[0]) === Number(/*max*/ ctx[2]);
    			attr_dev(button1, "class", "svelte-xu7z7u");
    			add_location(button1, file$7, 85, 4, 2127);
    			attr_dev(div0, "class", "number-row svelte-xu7z7u");
    			add_location(div0, file$7, 82, 2, 1949);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file$7, 81, 0, 1923);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				listen_dev(button0, "click", /*minus*/ ctx[6], false, false, false),
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	function add() {
    		$$invalidate(0, number = Number(number));
    	...
    	const writable_props = ["number", "min", "max", "hasSlider"];
    ...
    class Number_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { number: 0, min: 1, max: 2, hasSlider: 3 });
    ...
    const file$8 = "examples/year-in-toronto/Graph.svelte";

    // (21:2) <Column width="25px">
    ...
    function create_default_slot_10(ctx) {
    	...
    	const line1 = new Line({
    			props: {
    				space: "15px",
    				start: "October 16 " + /*year*/ ctx[2],
    				end: "Dec 31 " + /*year*/ ctx[2],
    				color: "red",
    				label: ""
    			},
    			$$inline: true
    ...
    function create_default_slot_8(ctx) {
    	...
    	const line = new Line({
    			props: {
    				space: "15px",
    				start: "March 3 " + /*year*/ ctx[2],
    				end: "Dec 1 " + /*year*/ ctx[2],
    				color: "tulip",
    				label: "TFC"
    			},
    			$$inline: true
    ...
    function create_default_slot_7(ctx) {
    	...
    	const line = new Line({
    			props: {
    				space: "15px",
    				start: "March 29 " + /*year*/ ctx[2],
    				end: "Oct 1 " + /*year*/ ctx[2],
    				color: "lightblue",
    				label: "Blue Jays"
    			},
    			$$inline: true
    ...
    // (31:2) <Page name="sports" page={pages[index]}>
    function create_default_slot_6(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(31:2) <Page name=\\\"sports\\\" page={pages[index]}>",
    		ctx
    	});
    ...
    function create_default_slot_5(ctx) {
    	...
    	const line0 = new Line({
    			props: {
    				space: "15px",
    				start: "Jan 1 " + /*year*/ ctx[2],
    				end: "Feb 10 " + /*year*/ ctx[2],
    				color: "lighter",
    				label: "snow"
    			},
    			$$inline: true
    ...
    function create_default_slot_4(ctx) {
    	...
    	const line = new Line({
    			props: {
    				space: "15px",
    				start: "May 24 " + /*year*/ ctx[2],
    				end: "Sept 1 " + /*year*/ ctx[2],
    				color: "purple",
    				label: "shorts"
    			},
    			$$inline: true
    ...
    // (52:2) <Page name="weather" page={pages[index]}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(52:2) <Page name=\\\"weather\\\" page={pages[index]}>",
    		ctx
    	});
    ...
    // (71:2) <Page name="more" page={pages[index]}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 71, 4, 2730);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(71:2) <Page name=\\\"more\\\" page={pages[index]}>",
    		ctx
    	});
    ...
    // (20:0) <Timeline {start} {end} {height} {title}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			column2.$set(column2_changes);
    			const page0_changes = {};
    			if (dirty & /*index*/ 1) page0_changes.page = /*pages*/ ctx[6][/*index*/ ctx[0]];
    			...
    			const page1_changes = {};
    			if (dirty & /*index*/ 1) page1_changes.page = /*pages*/ ctx[6][/*index*/ ctx[0]];
    			...
    			const page2_changes = {};
    			if (dirty & /*index*/ 1) page2_changes.page = /*pages*/ ctx[6][/*index*/ ctx[0]];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(20:0) <Timeline {start} {end} {height} {title}>",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	function number_number_binding(value) {
    		/*number_number_binding*/ ctx[8].call(null, value);
    	}

    	let number_props = { min: "1", max: "4", hasSlider: false };

    	if (/*index*/ ctx[0] !== void 0) {
    		number_props.number = /*index*/ ctx[0];
    	}

    	const number = new Number_1({ props: number_props, $$inline: true });
    	binding_callbacks.push(() => bind(number, "number", number_number_binding));
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_number && dirty & /*index*/ 1) {
    				updating_number = true;
    				number_changes.number = /*index*/ ctx[0];
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	return [index, title, year, start, end, height, pages, d, number_number_binding];
    }
